...
const monthlyData1 = [56, 67, 111, 99, 60, 115, 97, 123, 80, 70, 155, 38];
const weeklyData1 = [43, 40, 22, 57, 46, 119, 103];

const monthlyData2 = [111, 40, 158, 40, 70, 32, 22, 40, 61, 59, 51, 47];
const weeklyData2 = [22, 42, 55, 42, 44, 62, 51];
  ...
  const visibleSeries = [
    {
      ...
      visible: visibility['Total Customers']
    },
    {
      data: data2,
      label: 'Orders',
