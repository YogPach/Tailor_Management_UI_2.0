...
export default function SalesChart() {
  ...
  const warningColor = theme.palette.info.main;

  const labels = ['Jan', 'Feb', 'Mar', 'Apr', 'May', 'Jun', 'Jul', 'Aug', 'Sep', 'Oct', 'Nov', 'Dec'];
  const data = [
    { data: [190, 100, 145, 124, 130, 156, 180, 300, 180, 240, 220, 190], label: 'Income', color: warningColor, valueFormatter },
    { data: [130, 55, 88, 160, 178, 199, 190, 230, 190, 220, 230, 210], label: 'Cost of Sales', color: primaryColor, valueFormatter }
  ];
